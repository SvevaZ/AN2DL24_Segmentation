...
This project was organized as a competition on Kaggle and the the two final best models were evaluated using a secret test set.
...
3. 8pesto_postprocessing_model.ipynb: first model, see details in 8pesto_report
4. 8pesto_weight0_model.ipynb: second model, see details in 8pesto_report
